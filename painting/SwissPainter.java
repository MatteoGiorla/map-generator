...
/**
 * Un peintre pour les cartes dont le style est fortement inspiré des cartes
 * topographiques suisses
 * 
...
public final class SwissPainter {
    ...
    static {
       ...
       Painter fgPainter =
                roadPainter
                .above(line(0.5f, darkGray, Termination.CAP_ROUND, Join.JOIN_MITER, 1f, 2f).when(tagged("highway", "footway", "steps", "path", "track", "cycleway")))
